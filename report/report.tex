...
\begin{abstract}
    ...
    The library accomplishes this by using annotations and macros, and requires little to no knowledge of the Scala reflection API.\
    ...
    By leveraging Directembedding features, slick-direct is able to support a large feature set of the Slick deep embedding in under 300 lines of code.
\end{abstract}
\end{sloppypar}
